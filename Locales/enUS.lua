...
L["EXPORT_STRING"] = "Copy this string to share:"
L["IMPORT_STRING"] = "Paste a string to import:"
L["IMPORT_SUCCESS"] = "Successfully imported %d item(s)."
L["IMPORT_FAILED"] = "Import failed. Invalid data."
L["SAVE_TO_FILE"] = "Save to File"
L["LOAD_FROM_FILE"] = "Load from File"
